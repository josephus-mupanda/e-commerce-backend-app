    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("v1.0.0")
                        .description("REST API documentation for the E-commerce App system. This API manages .....")
                        .contact(new Contact()
                ...
                .servers(List.of(
                        ...
                        new Server().url("https://e-commerce-app-api.onrender.com").description("Production Server")
                ))
